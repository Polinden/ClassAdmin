    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if (settings.icon !== 'none') {
                icon = '<text text-anchor="middle" x="' + iconX + '" y="' + iconY + '" class="icon" style="font-family: \'Font Awesome 5 Free\'; font-weight: 900; font-size: ' + settings.iconSize + 'px" fill="' + settings.iconColor + '">&#x' + settings.icon + '</text>';
            }
